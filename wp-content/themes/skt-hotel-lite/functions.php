...
define('SKT_PRO_THEME_URL','https://www.sktthemes.org/shop/hotel-wordpress-theme/');
define('SKT_PRO_FONT_AWESOME_URL','http://fortawesome.github.io/Font-Awesome/icons/');
define('SKT_LIVE_DEMO_URL','http://sktthemesdemo.net/hotel/');
...
add_action( 'tgmpa_register', 'skt_hotel_lite_register_required_plugins' );
 
function skt_hotel_lite_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
