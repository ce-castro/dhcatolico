                    ...
                    <h1 class="page-title">
                        <?php
                            ...
                            elseif ( is_author() ) :
                                ...
                                */
                                the_post();
                                printf( __( 'Author: %s', 'skt-hotel' ), '<span class="vcard">' . get_the_author() . '</span>' );
                            ...
                            elseif ( is_day() ) :
                                printf( __( 'Day: %s', 'skt-hotel' ), '<span>' . get_the_date() . '</span>' );
    
                            elseif ( is_month() ) :
                                printf( __( 'Month: %s', 'skt-hotel' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );
    
                            elseif ( is_year() ) :
                                printf( __( 'Year: %s', 'skt-hotel' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
