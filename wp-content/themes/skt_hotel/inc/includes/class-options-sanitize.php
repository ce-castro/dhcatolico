...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-hotel' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-hotel' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-hotel' ),
		'repeat'    => __( 'Repeat All', 'skt-hotel' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-hotel' ),
		'top center'    => __( 'Top Center', 'skt-hotel' ),
		'top right'     => __( 'Top Right', 'skt-hotel' ),
		'center left'   => __( 'Middle Left', 'skt-hotel' ),
		'center center' => __( 'Middle Center', 'skt-hotel' ),
		'center right'  => __( 'Middle Right', 'skt-hotel' ),
		'bottom left'   => __( 'Bottom Left', 'skt-hotel' ),
		'bottom center' => __( 'Bottom Center', 'skt-hotel' ),
		'bottom right'  => __( 'Bottom Right', 'skt-hotel')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-hotel' ),
		'fixed'  => __( 'Fixed in Place', 'skt-hotel')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-hotel' ),
		'italic'      => __( 'Italic', 'skt-hotel' ),
		'bold'        => __( 'Bold', 'skt-hotel' ),
		'bold italic' => __( 'Bold Italic', 'skt-hotel' )
		);
