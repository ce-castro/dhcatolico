...
function ts_fab_show_latest_posts( $context = '', $authorid = '' ) {
	...
	<div class="ts-fab-tab" id="ts-fab-latest-posts-' . $context . '">
		...
		<div class="ts-fab-text">
			<div class="ts-fab-header">
				<h4>' . __( 'Escrito por ', 'ts-fab' ) . $author->display_name . ' <span class="latest-see-all">(<a href="' . get_author_posts_url( $author->ID ) . '" rel="nofollow">' . __( 'Ver Todo', 'ts-fab' ) . '</a>)</span></h4>
			</div>
...
function ts_fab_construct_fab( 
	...
	$ts_fab = '<div id="ts-fab-' . $context . '" class="ts-fab-wrapper">';
		...
		$ts_fab .= '<ul class="ts-fab-list">';
			...
			$ts_fab .= '<li class="ts-fab-latest-posts-link"><a href="#ts-fab-latest-posts-' . $context . '">' . __( 'Otras Publicaciones', 'ts-fab' ) . '</a></li>';
